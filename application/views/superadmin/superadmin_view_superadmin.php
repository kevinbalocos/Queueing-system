...
<body class="bg-dark-900 text-white font-sans h-screen overflow-hidden">
  ...
  <div class="bg-white rounded-lg shadow-lg max-w-md w-full mx-4 overflow-hidden">
    ...
    <div class="px-6 py-4">
      <p class="text-gray-700">Are you sure you want to delete <span id="deleteUsername" class="font-medium"></span>? This action cannot be undone.</p>
    </div>
...
<script>
  function confirmDelete(username, userId) {
    ...
    document.getElementById('confirmDelete').onclick = function() {
      // Perform deletion (replace with your deletion logic)
